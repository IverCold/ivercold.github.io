...
```json
    ...
    {
        "Form": "Защитные очки, пара очков, полная или полумаска, закрывающая глаза с линзами",
        "Depletion": "1 in 1d20 при активации линз (после истощения очки можно носить как обычные очки)",
        "Name": "Aim True Goggles",
        "NameRu": "Очки точного прицела",
        "Level": "1d6",
        "Effect": "Нажимая на небольшие кнопки с обеих сторон устройства, пользователь активирует линзы. Эти специальные линзы блокируют синие и фиолетовые лучи, которые могут ухудшить видимость, тем самым улучшая зрение владельца. При ношении очков пользователь получает {+1|+2} на атаки Дальнего боя. Действует в течение часа.",
        "Categories": "Utility",
        "Source": "Compendium"
    }
```
